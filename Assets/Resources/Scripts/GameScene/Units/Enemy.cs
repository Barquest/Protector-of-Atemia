		...
		public void PushingToPool()
		{
			switch (data.type)
			{
				...
				case UnitType.GoblinBamboo:
					ObjectPoolController.Instance.goblinBambooPool.Push(this);
					break;
				case UnitType.GoblinCrossbow:
					ObjectPoolController.Instance.goblinCrossbowPool.Push(this);
					break;
				case UnitType.GoblinKujang:
					ObjectPoolController.Instance.goblinKujangPool.Push(this);
					break;
				case UnitType.GoblinSumpit:
					ObjectPoolController.Instance.goblinSumpitPool.Push(this);
					break;
			}
		}
